...
// This is 99.9% copy paste from the original vanilla Terminator Sequence script
public class OasDroneStrikeStats extends BaseShipSystemScript implements DroneStrikeStatsAIInfoProvider {
...
//				drone.setHitpoints(-1f);
				...
				EmpArcEntityAPI arc = engine.spawnEmpArcVisual(getOrbLocation(ship), ship,
						missile.getLocation(), missile, thickness, new Color(100,100,255,255), Color.white);
				arc.setCoreWidthOverride(thickness * coreWidthMult);
				arc.setSingleFlickerMode();
				Global.getSoundPlayer().playSound("oas_snapper", 0.666f, 0.666f, missile.getLocation(), missile.getVelocity());
			} else {
    ...
    private Vector2f getOrbLocation(ShipAPI ship) {
        ...
        for(WeaponAPI weapon : weapons) {
            if("oas_orb_gazer".equals(weapon.getId())) {
