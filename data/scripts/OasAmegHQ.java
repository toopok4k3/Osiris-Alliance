...
public class OasAmegHQ extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {
	
	@Override
	public boolean isHidden() {
		return !market.getFactionId().equals("osiris");
	}
	
	@Override
	public boolean isFunctional() {
		return super.isFunctional() && market.getFactionId().equals("osiris");
	}
...
protected IntervalUtil tracker = new IntervalUtil(5f, 9f);
	...
	public void advance(float amount) {
		...
		if (returningPatrolValue > 0f) {
			...
			if (returningPatrolValue < 0f) returningPatrolValue = 0f;
		}
		...
		if (tracker.intervalElapsed()) {
            ...
            } else if(medium - maxMedium < 0) {
                type = PatrolType.COMBAT;
            } else if(heavy - maxHeavy < 0) {
...
//		fleet.addScript(ai);
	...
	public String getRouteSourceId() {
		return getMarket().getId() + "_" + "ameghq";
	}
